...
return setmetatable(Struct, {
    __call = function(self)
        Il2Cpp.Version = require("Version")()
...
local x64 = info.x64
local MainType = x64 and gg.TYPE_QWORD or gg.TYPE_DWORD
local pointSize = x64 and 8 or 4
...
local Searcher = {
    ...
    Il2CppMetadataRegistration = function()
        ...
        Il2Cpp.classPointer = Il2Cpp.Version < 27 and (Il2Cpp.x64 and 24 or 12) or (Il2Cpp.x64 and 40 or 20);
        Il2Cpp.imagePointer = Il2Cpp.Version < 27 and (Il2Cpp.x64 and 72 or 36) or (Il2Cpp.x64 and 24 or 12);
        local gmt = gg.getRangesList("global-metadata.dat");
	    local gmt = ((#gmt > 0) and gmt[1].start) or Il2Cpp.Meta.metaStart
	    gg.clearResults();
	    gg.setRanges(16 | 32);
	    gg.searchNumber(gmt, Il2Cpp.MainType, nil, nil, Il2Cpp.il2cppStart, -1, 1);
	    if gg.getResultsCount() == 0 and x64 and info.sdk >= 30 then
        ...
        Il2Cpp.typeCount = classCount
        
        Il2Cpp.metaReg = g_meta
        Il2Cpp.il2cppReg = g_code
